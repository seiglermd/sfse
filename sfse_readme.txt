Starfield Script Extender v0.2.20 pre-alpha
...
SFSE will support the latest version of Starfield available on Steam, currently 1.16.242. The Gamepass/MS Store/EGS version is unsupported. Do not email asking for support.
