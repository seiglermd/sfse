...
public:
	...
	struct ParameterInfo
	{
		...
		DEFINE_MEMBER_FN(GetParam, u64 *, 0x02827440, u32 idx, BSFixedString * nameOut, u64 * typeOut);
	};
	...
	DEFINE_MEMBER_FN(Impl_Invoke, u32, 0x02827B10, u64 unk0, u64 unk1, VMClassRegistry * registry, VMState * unk3);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x10
	DEFINE_MEMBER_FN(Impl_Fn10, BSFixedString *, 0x028274F0);
	DEFINE_MEMBER_FN(Impl_GetParamInfo, bool, 0x02827510, u32 idx, void * out);
	DEFINE_MEMBER_FN(Impl_Fn15, void *, 0x028275D0, u64 arg0, u64 arg1);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x028276A0, const char * fnName, const char * className, u8 unk0, u32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x02827A70);	// same as NativeFunctionBase dtor
