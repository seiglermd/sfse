...
public:
	...
	struct ParameterInfo
	{
		...
		DEFINE_MEMBER_FN(GetParam, u64 *, 0x02827290, u32 idx, BSFixedString * nameOut, u64 * typeOut);
	};
	...
	DEFINE_MEMBER_FN(Impl_Invoke, u32, 0x02827960, u64 unk0, u64 unk1, VMClassRegistry * registry, VMState * unk3);
	// ??_7?$NativeFunction1@VActiveEffect@@XPEAVTESForm@@@BSScript@@6B@ entry 0x10
	DEFINE_MEMBER_FN(Impl_Fn10, BSFixedString *, 0x02827340);
	DEFINE_MEMBER_FN(Impl_GetParamInfo, bool, 0x02827360, u32 idx, void * out);
	DEFINE_MEMBER_FN(Impl_Fn15, void *, 0x02827420, u64 arg0, u64 arg1);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x028274F0, const char * fnName, const char * className, u8 unk0, u32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x028278C0);	// same as NativeFunctionBase dtor
