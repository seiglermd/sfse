...
public:
	...
	DEFINE_MEMBER_FN_0(IsInSpaceship, bool, 0x02119A10)
	DEFINE_MEMBER_FN_0(IsInSpace, bool, 0x00B59630)
	DEFINE_MEMBER_FN_1(HasKeyword, bool, 0x004803A0, BGSKeyword*);
};
...
public:
	...
	DEFINE_MEMBER_FN_3(UpdateAppearance, void, 0x01960070, bool unk1, u32 flags, bool changeRace);

	DEFINE_MEMBER_FN_0(UpdateChargenAppearance, void, 0x017AB600);
	DEFINE_MEMBER_FN_1(SetSkinTone, void, 0x017ABEB0, u32 skinToneIndex);
