...
//	DEFINE_MEMBER_FN_1(AddExtraData, bool, 0x037E6D0C, NiExtraData* pkExtra);
	DEFINE_MEMBER_FN_1(AddExtraData_NoLock, bool, 0x02BE42C0, NiExtraData * pkExtra);	// version that doesn't take the lock
};
...
public:
	...
	DEFINE_MEMBER_FN_1(Update, void, 0x02BD89F0, NiUpdateData& apData);
};
