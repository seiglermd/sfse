...
public:
    ...
    public:
        ...
        DEFINE_MEMBER_FN_3(HasMember, bool, 0x03356280, void* pData, const char* name, bool isDisplayObj);
        DEFINE_MEMBER_FN_4(GetMember, bool, 0x033565C0, void* pData, const char* name, Value* pValue, bool isDisplayObj);
        DEFINE_MEMBER_FN_4(SetMember, bool, 0x033569B0, void* pData, const char* name, const Value& pValue, bool isDisplayObj);
        DEFINE_MEMBER_FN_6(Invoke, bool, 0x03356DD0, void* pData, Value* result, const char* name, const Value* args, unsigned long long numArgs, bool isDisplayObj);
        DEFINE_MEMBER_FN_4(CreateEmptyMovieClip, bool, 0x0335A4F0, void* pData, Value* pValue, const char* instanceName, int depth);
        DEFINE_MEMBER_FN_6(AttachMovie, bool, 0x0335A7B0, void* pData, Value* pValue, const char* symbolName, const char* instanceName, int depth, const void* initArgs);
        DEFINE_MEMBER_FN_1(GetArraySize, unsigned int, 0x033580B0, void* pData);
        DEFINE_MEMBER_FN_2(SetArraySize, bool, 0x033580C0, void* pData, unsigned int size);
        DEFINE_MEMBER_FN_3(GetElement, bool, 0x033580E0, void* pData, unsigned int index, Value* value);
        DEFINE_MEMBER_FN_3(SetElement, bool, 0x03358170, void* pData, unsigned int index, const Value& value);
        DEFINE_MEMBER_FN_2(PushBack, bool, 0x033583B0, void* pData, const Value& value);
        DEFINE_MEMBER_FN_2(PopBack, bool, 0x03358410, void* pData, Value* value);
        DEFINE_MEMBER_FN_3(RemoveElements, bool, 0x033584C0, void* pData, unsigned idx, int count);
        DEFINE_MEMBER_FN_4(VisitElements, void, 0x033581D0, void* pData, ArrVisitor* visitor, unsigned long idx, int count);
        DEFINE_MEMBER_FN_3(VisitMembers, void, 0x03357970, void* pData, ObjVisitor* visitor, bool isDisplayObj);
        // DeleteMember TBD
        DEFINE_MEMBER_FN_3(GetText, bool, 0x0335A180, void* pData, Value* value, bool html);
        DEFINE_MEMBER_FN_3(SetText, bool, 0x0335A2E0, void* pData, const char* text, bool html);
        DEFINE_MEMBER_FN_3(SetTextW, bool, 0x0335A400, void* pData, const wchar_t* text, bool html);
        DEFINE_MEMBER_FN_3(GotoAndPlayL, bool, 0x0335AC60, void* pData, const char* frame, bool stop);
        DEFINE_MEMBER_FN_3(GotoAndPlay, bool, 0x0335AD60, void* pData, unsigned frame, bool stop);
        DEFINE_MEMBER_FN_2(GetParent, bool, 0x033589E0, void* pData, Value* value);
        // GetDisplayInfo TBD
        // SetDisplayInfo TBD
        ...
        DEFINE_MEMBER_FN_2(ObjectAddRef, void, 0x03356120, Value* value, void* pData);
        DEFINE_MEMBER_FN_2(ObjectRelease, void, 0x033561C0, Value* value, void* pData);
