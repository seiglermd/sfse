...
{
public:
	DEFINE_MEMBER_FN_0(lock_read, void, 0x022CEAB0);
	DEFINE_MEMBER_FN_0(lock_write, void, 0x022CEB30);
...
{
public:
	DEFINE_MEMBER_FN_0(lock, void, 0x022CB400);
	DEFINE_MEMBER_FN_0(try_lock, bool, 0x022CB3B0);
